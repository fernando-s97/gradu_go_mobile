...
import 'package:gradu_go/src/domain/use_case/get_event_details_use_case.dart'
    as _i14;
import 'package:gradu_go/src/domain/use_case/get_events_use_case.dart' as _i15;
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i13.GetGraduateDetailsUseCase>(() =>
        _i13.GetGraduateDetailsUseCase(
            graduateRepository: gh<_i10.GraduateRepository>()));
    gh.lazySingleton<_i14.GetEventDetailsUseCase>(() =>
        _i14.GetEventDetailsUseCase(
            eventRepository: gh<_i6.EventRepository>()));
    gh.lazySingleton<_i15.GetEventsUseCase>(() =>
        _i15.GetEventsUseCase(eventRepository: gh<_i6.EventRepository>()));
    return this;
  }
}
